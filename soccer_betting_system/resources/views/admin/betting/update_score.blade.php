...
@section('content')
    <h1 class="title_edit">Update score match </h1>
	...
	{!! Form::model($match, [ 'method'=>'PATCH' , 'action'=>['Admin\BettingController@update', $match->id ] ]) !!}
		...
		<div class="form-group">
			<div class="row">
	            ...
	            <div class="col-sm-3">
			      	{!! Form::text('home_team_id', null, ['class'=>'form-control' , 'disabled' => 'disabled']) !!}
			    </div>
			    <div class="col-sm-3">
			      	 {!! Form::text('away_team_id', null, ['class'=>'form-control' , 'disabled' => 'disabled']) !!}
			    </div>
		...
		<div class="form-group">
			<div class="row">
				<label class="control-label col-sm-2" for="">Score</label>
				<div class="col-sm-1">
		...
		<div class="form-group">
			<div class="row">
	           	...
	           	<div class='input-group date col-sm-3' id='dpk_match_start_time'>
                	<input type='text' class="form-control" name="time_start_match" value="{{$match->time_start_match}}" disabled="disabled" id="match_end_time" placeholder="Enter match start time" />
		...
		<div class="form-group">
			<div class="row">
	           	...
	           	<div class='input-group date col-sm-3' id='dpk_match_end_time'>
                	<input type='text' class="form-control" name="time_end_match" value="{{$match->time_end_match}}" id="match_end_time" disabled="disabled" placeholder="Enter match start time" />
	               	<span class="input-group-addon">
	                    <span class="glyphicon glyphicon-calendar"></span>
	                </span>
            	</div>
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-sm-3 toggle_div">
					@if($match->active == 1)
						<input id="toggle_input" name="active" type="checkbox" value="{{$match->active}}"  data-toggle="toggle" data-size="small" data-onstyle="success" data-offstyle="danger" checked disabled="disabled" />
					@else
						<input id="toggle_input" name="active" type="checkbox" value="{{$match->active}}"  data-toggle="toggle" data-size="small" data-onstyle="success" data-offstyle="danger" disabled="disabled"/>
					@endif
				</div>
			</div>
