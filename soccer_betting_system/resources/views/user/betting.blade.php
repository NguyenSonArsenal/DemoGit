            ...
            <div class="content_betting">
                ...
                <div class="row">
                    ...
                    {!! Form::model($match, [ 'method'=>'POST', 'action'=>['User\UserBettingController@store'] , 'class'=>'form-inline' ]) !!}
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="rate_home" value="" id="text" placeholder="bet_home_win ($)">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control" name="rate_draw" id="text" value="" placeholder="bet_draw_team ($)">
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control" name="rate_away" id="text" value="" placeholder="bet_away_win ($)">
                                    </div>
